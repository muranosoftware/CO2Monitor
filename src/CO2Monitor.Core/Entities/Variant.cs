...
namespace CO2Monitor.Core.Entities {
	public class Variant {
		...
		public Variant() {
			Declaration = new VariantDeclaration(ValueTypes.Void);
		}
		...
		public Variant(float value) {
			Declaration = new VariantDeclaration(ValueTypes.Float);
			_float = value;
		}

		public Variant(TimeSpan time) {
			Declaration = new VariantDeclaration(ValueTypes.Time);
			_time = time;
		}

		public Variant(string value) {
			Declaration = new VariantDeclaration(ValueTypes.String);
			_string = value;
		}

		public Variant(string value, IReadOnlyList<string> enumValues) {
			Declaration = new VariantDeclaration(ValueTypes.Enum, enumValues);
